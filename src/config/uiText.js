...
const VI_TEXT = {
  ...
  account: {
    ...
    topUp: {
      title: 'Nạp thêm vé',
      description: 'Chuyển khoản với nội dung là ID của bạn để nạp thêm vé.',
      paypal: 'Chuyển qua PayPal',
      crypto: 'Chuyển qua Ví Crypto',
      copyId: 'Sao chép ID',
...
const EN_TEXT = {
  ...
  account: {
    ...
    topUp: {
      ...
      description: 'Transfer with your ID as content to top up tickets.',
      paypal: 'Transfer via PayPal',
      crypto: 'Transfer via Crypto Wallet',
      copyId: 'Copy ID',
