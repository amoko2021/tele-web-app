...
export const TaskButton = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center gap-1.5 rounded-lg bg-gradient-to-r ${gradientColors} px-2.5 py-1 text-[11px] font-bold text-white hover:from-amber-600 hover:to-orange-700 transition-colors whitespace-nowrap flex-shrink-0`}
      >
